export default function HighlightsSection({ aiHighlights = [] }) {
  return (
    <section className="mt-10 w-full max-w-6xl mx-auto">
      <div className="rounded-2xl p-[2px] bg-gradient-to-r from-purple-500/40 via-blue-500/30 to-indigo-500/40 shadow-[0_0_35px_rgba(80,80,255,0.3)]">
        <div className="bg-[#0f1020]/80 rounded-2xl p-8 backdrop-blur-xl">
